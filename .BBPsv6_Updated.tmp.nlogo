...
securityResearchers-own [
  ...
  experienceLevel
  creativity
  memory;; to develop module for this
]
...
;to create-bugs-for-companies
;  ask companies [
;    let current-company self
;    repeat num-of-bugs [
;      create-turtles 1 [
;        set color blue
;        set size 1
;        setxy random-xcor random-ycor
;        ;set company current-company ; Assign the current company as the owner of the bug
;
;      ]
;    ]
;  ]
